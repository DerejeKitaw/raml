...
- [RAML Data Types](#raml-data-types)
  ...
  - [Built-in Types](#built-in-types)
    - [The "Any" Type](#the-%22any%22-type)
    ...
    - [Using XML and JSON Schema](#using-xml-and-json-schema)
      - [References to Inner Elements](#references-to-inner-elements)
  ...
  - [Defining Examples in RAML](#defining-examples-in-raml)
    ...
    - [Single Example](#single-example)
      - [As an explicit description of a specific type instance](#as-an-explicit-description-of-a-specific-type-instance)
      - [As a map that contains additional facets](#as-a-map-that-contains-additional-facets)
...
- [Modularization](#modularization)
  ...
  - [Libraries](#libraries)
    - [Applying Libraries](#applying-libraries)
